    ...
    public static readonly IReadOnlyDictionary<string, RoveCommBoardDesc> Boards = new Dictionary<string, RoveCommBoardDesc>
    {
        ...
        (
            ...
            commands: new Dictionary<string, RoveCommPacketDesc>
            {
                ...
                ["DriveLeftRight"] = new RoveCommPacketDesc(3000, 2, RoveCommDataType.FLOAT),
                // [LF, LM, LR, RF, RM, RR] (-1, 1)-> (-100%, 100%)
                ["DriveIndividual"] = new RoveCommPacketDesc(3001, 6, RoveCommDataType.FLOAT),
                // [0-override off, 1-override on]
                ["WatchdogOverride"] = new RoveCommPacketDesc(3002, 1, RoveCommDataType.UINT8_T),
                // [Tilt](degrees -180-180)
                ["LeftDriveGimbalIncrement"] = new RoveCommPacketDesc(3003, 1, RoveCommDataType.INT16_T),
                // [Tilt](degrees -180-180)
                ["RightDriveGimbalIncrement"] = new RoveCommPacketDesc(3004, 1, RoveCommDataType.INT16_T),
                // [Pan, Tilt](degrees -180-180)
                ["LeftMainGimbalIncrement"] = new RoveCommPacketDesc(3005, 2, RoveCommDataType.INT16_T),
                // [Pan, Tilt](degrees -180-180)
                ["RightMainGimbalIncrement"] = new RoveCommPacketDesc(3006, 2, RoveCommDataType.INT16_T),
                // [Tilt](degrees -180-180)
                ["BackDriveGimbalIncrement"] = new RoveCommPacketDesc(3007, 1, RoveCommDataType.INT16_T),
                // [R, G, B] (0, 255)
                ["LEDRGB"] = new RoveCommPacketDesc(3008, 3, RoveCommDataType.UINT8_T),
                // [Pattern] (Enum)
                ["LEDPatterns"] = new RoveCommPacketDesc(3009, 1, RoveCommDataType.UINT8_T),
                // [Teleop, Autonomy, Reached Goal] (enum)
                ["StateDisplay"] = new RoveCommPacketDesc(3010, 1, RoveCommDataType.UINT8_T),
                // Set Brightness (0-255)
                ["Brightness"] = new RoveCommPacketDesc(3011, 1, RoveCommDataType.UINT8_T),
                // 0: Teleop, 1: Autonomy
                ["SetWatchdogMode"] = new RoveCommPacketDesc(3012, 1, RoveCommDataType.UINT8_T),
                // Set the message to display on the lighting panel; null terminator ends string early
                ["LEDText"] = new RoveCommPacketDesc(3013, 256, RoveCommDataType.CHAR)
            },
            telemetry: new Dictionary<string, RoveCommPacketDesc>
            {
                // [LF, LM, LR, RF, RM, RR] (-1, 1)-> (-100%, 100%)
                ["DriveSpeeds"] = new RoveCommPacketDesc(3100, 6, RoveCommDataType.FLOAT),
                // [Roll, Pitch, Yaw] degrees
                ["IMUData"] = new RoveCommPacketDesc(3101, 3, RoveCommDataType.FLOAT),
        ...
        (
            ...
            commands: new Dictionary<string, RoveCommPacketDesc>
            {
                ...
                ["EStop"] = new RoveCommPacketDesc(4000, 1, RoveCommDataType.UINT8_T),
                // Power off all systems including network, cannot recover without physical reboot (PMS will stay on)
                ["Suicide"] = new RoveCommPacketDesc(4001, 1, RoveCommDataType.UINT8_T),
                // Cycle all systems including network off and back on (PMS will stay on)
                ["Reboot"] = new RoveCommPacketDesc(4002, 1, RoveCommDataType.UINT8_T),
                // [Motor, Core, Aux] (bitmasked) [1-Enable, 0-No change]
                ["EnableBus"] = new RoveCommPacketDesc(4003, 1, RoveCommDataType.UINT8_T),
                // [Motor, Core, Aux] (bitmasked) [1-Disable, 0-No change]
                ["DisableBus"] = new RoveCommPacketDesc(4004, 1, RoveCommDataType.UINT8_T),
                // [Motor, Core, Aux] (bitmasked) [1-Enable, 0-Disable]
                ["SetBus"] = new RoveCommPacketDesc(4005, 1, RoveCommDataType.UINT8_T)
            },
            telemetry: new Dictionary<string, RoveCommPacketDesc>
            {
                // Total current draw from battery
                ["PackCurrent"] = new RoveCommPacketDesc(4100, 1, RoveCommDataType.FLOAT),
                // Pack voltage
                ["PackVoltage"] = new RoveCommPacketDesc(4101, 1, RoveCommDataType.FLOAT),
                // C1, C2, C3, C4, C5, C6
                ["CellVoltage"] = new RoveCommPacketDesc(4102, 6, RoveCommDataType.FLOAT),
                // Current draw by aux systems (before 12V buck)
                ["AuxCurrent"] = new RoveCommPacketDesc(4103, 1, RoveCommDataType.FLOAT),
                // Current draw from other devices (CS1, CS2, CS3)
                ["MiscCurrent"] = new RoveCommPacketDesc(4104, 3, RoveCommDataType.FLOAT),
            ...
            errors: new Dictionary<string, RoveCommPacketDesc>
            {
                ...
                ["CellUndervoltage"] = new RoveCommPacketDesc(4201, 1, RoveCommDataType.UINT8_T),
                // (bitmasked) [1-Critical, 0-OK]. Rover will Suicide automatically
                ["CellCritical"] = new RoveCommPacketDesc(4202, 1, RoveCommDataType.UINT8_T),
                // Aux system current draw too high. Rover will disable Aux bus automatically
                ["AuxOvercurrent"] = new RoveCommPacketDesc(4203, 1, RoveCommDataType.UINT8_T)
            }
        ),
        ...
        (
            ...
            telemetry: new Dictionary<string, RoveCommPacketDesc>
            {
                ...
                ["GPSLatLonAlt"] = new RoveCommPacketDesc(6100, 3, RoveCommDataType.DOUBLE),
                // [Pitch, Yaw, Roll] [(-90, 90), (0, 360), (-90, 90)] (deg)
                ["IMUData"] = new RoveCommPacketDesc(6101, 3, RoveCommDataType.FLOAT),
                // [Heading] [ 0, 360 ]
                ["CompassData"] = new RoveCommPacketDesc(6102, 1, RoveCommDataType.FLOAT),
                // [Number of satellites]
                ["SatelliteCountData"] = new RoveCommPacketDesc(6103, 1, RoveCommDataType.UINT8_T),
                // [xAxis, yAxis, zAxis] Accel in m/s^2
                ["AccelerometerData"] = new RoveCommPacketDesc(6104, 3, RoveCommDataType.FLOAT),
        ...
        (
            ...
            commands: new Dictionary<string, RoveCommPacketDesc>
            {
                ...
                ["OpenLoop"] = new RoveCommPacketDesc(7000, 1, RoveCommDataType.INT16_T),
                // [Heading] [0, 360)
                ["SetAngleTarget"] = new RoveCommPacketDesc(7001, 1, RoveCommDataType.FLOAT),
                // [Rover Lat, Rover Long, Basestation Lat, Basestation Long] [Lat:(-90, 90), Long:(-180, 180)] (deg)
                ["SetGPSTarget"] = new RoveCommPacketDesc(7002, 4, RoveCommDataType.DOUBLE),
                // [0-override off, 1-override on]
                ["WatchdogOverride"] = new RoveCommPacketDesc(7003, 1, RoveCommDataType.UINT8_T)
            },
            telemetry: new Dictionary<string, RoveCommPacketDesc>
            {
                // [Heading] [0, 360)
        ...
        (
            ...
            commands: new Dictionary<string, RoveCommPacketDesc>
            {
                ...
                ["OpenLoop"] = new RoveCommPacketDesc(8000, 6, RoveCommDataType.INT16_T),
                // [X, Y1, Y2, Z, P, R] (in, in, in, in, deg, deg)
                ["SetPosition"] = new RoveCommPacketDesc(8001, 6, RoveCommDataType.FLOAT),
                // [X, Y, Z, P, R] (in, in, in, deg, deg, deg)
                ["IncrementPosition"] = new RoveCommPacketDesc(8002, 5, RoveCommDataType.FLOAT),
                // [X, Y, Z, P, R] (in, in, in, deg, deg)
                ["SetIK"] = new RoveCommPacketDesc(8003, 5, RoveCommDataType.FLOAT),
                // [X, Y, Z, P, R] (in, in, in, deg, deg)
                ["IncrementIK_RoverRelative"] = new RoveCommPacketDesc(8004, 5, RoveCommDataType.FLOAT),
                // [X, Y, Z, P, R] (in, in, in, deg, deg)
                ["IncrementIK_WristRelative"] = new RoveCommPacketDesc(8005, 5, RoveCommDataType.FLOAT),
                // [0-disable, 1-enable]
                ["Laser"] = new RoveCommPacketDesc(8006, 1, RoveCommDataType.UINT8_T),
                // [0-retract, 1-extend]
                ["Solenoid"] = new RoveCommPacketDesc(8007, 1, RoveCommDataType.UINT8_T),
                // Motor decipercent [-1000, 1000]
                ["Gripper"] = new RoveCommPacketDesc(8008, 1, RoveCommDataType.INT16_T),
                // [0-override off, 1-override on]
                ["WatchdogOverride"] = new RoveCommPacketDesc(8009, 1, RoveCommDataType.UINT8_T),
                // [X+, X-, Y1+, Y1-, Y2+, Y2-, Z+, Z-, P+, P-] (0-override off, 1-override on) (bitmasked)
                ["LimitSwitchOverride"] = new RoveCommPacketDesc(8010, 1, RoveCommDataType.UINT16_T),
                // [X, Y1, Y2, Z, P, R1, R2] (1-calibrate, 0-no action) (bitmasked)
                ["CalibrateEncoder"] = new RoveCommPacketDesc(8011, 1, RoveCommDataType.UINT8_T),
                // Toggle gripper and roll motors controlled by other packets; 0-Gripper1, 1-Gripper2
                ["SelectGripper"] = new RoveCommPacketDesc(8012, 1, RoveCommDataType.UINT8_T),
                // [X+, X-, Y1+, Y1-, Y2+, Y2-, Z+, Z-, P+, P-] (0-override off, 1-override on) (bitmasked)
                ["SoftLimitOverride"] = new RoveCommPacketDesc(8013, 1, RoveCommDataType.UINT8_T)
            },
            telemetry: new Dictionary<string, RoveCommPacketDesc>
            {
        ...
        (
            ...
            errors: new Dictionary<string, RoveCommPacketDesc>
            {
                ...
                // (1-Stalled, 0-OK)
                ["AugerStalled"] = new RoveCommPacketDesc(9201, 1, RoveCommDataType.UINT8_T)
            }
        ),
        ...
        (
            ...
            {
                // Enum (AUTONOMYSTATE)
                ["CurrentState"] = new RoveCommPacketDesc(11100, 1, RoveCommDataType.UINT8_T),
                // 
        ...
        (
            ...
            commands: new Dictionary<string, RoveCommPacketDesc>
            {
                ...
                ["ChangeCameras"] = new RoveCommPacketDesc(12000, 2, RoveCommDataType.UINT8_T),
                ...
                ["TakePicture"] = new RoveCommPacketDesc(12001, 2, RoveCommDataType.UINT8_T),
                // Stop the current camera stream. [0] is the camera to stop streaming. [1] is whether to restart the stream.
                ["ToggleStream1"] = new RoveCommPacketDesc(12002, 2, RoveCommDataType.UINT8_T)
            },
            telemetry: new Dictionary<string, RoveCommPacketDesc>
            {
                // Bitmask values for which cameras are able to stream. LSB is Camera 0, MSB is Camera 7.
                ["AvailableCameras"] = new RoveCommPacketDesc(12100, 1, RoveCommDataType.UINT8_T),
                // Which cameras the system is currently streaming on each port
                ["StreamingCameras"] = new RoveCommPacketDesc(12101, 4, RoveCommDataType.UINT8_T),
        ...
        (
            ...
            commands: new Dictionary<string, RoveCommPacketDesc>
            {
                ...
                ["TakePhoto"] = new RoveCommPacketDesc(14000, 1, RoveCommDataType.UINT8_T),
                // Stop the current camera stream. [0] is the camera to stop streaming. [1] is the action (0 = Shutdown, 1 = Startup, 2 = Restart).
                ["ToggleStream"] = new RoveCommPacketDesc(14001, 2, RoveCommDataType.UINT8_T),
                // Adjust brightness level (0-255). [0] is the camera ID, [1] is the brightness level.
                ["AdjustBrightness"] = new RoveCommPacketDesc(14002, 2, RoveCommDataType.UINT8_T),
                // Adjust contrast level (0-255). [0] is the camera ID, [1] is the contrast level.
                ["AdjustContrast"] = new RoveCommPacketDesc(14003, 2, RoveCommDataType.UINT8_T),
                // Adjust saturation level (0-255). [0] is the camera ID, [1] is the saturation level.
                ["AdjustSaturation"] = new RoveCommPacketDesc(14004, 2, RoveCommDataType.UINT8_T),
                // Adjust hue level (0-255). [0] is the camera ID, [1] is the hue level.
                ["AdjustHue"] = new RoveCommPacketDesc(14005, 2, RoveCommDataType.UINT8_T),
                // Set white balance temperature. [0] is the camera ID, [1] is the white balance level.
                ["SetWhiteBalance"] = new RoveCommPacketDesc(14008, 2, RoveCommDataType.UINT8_T),
                // Adjust backlight contrast level (0-255). [0] is the camera ID, [1] is the backlight contrast level.
                ["AdjustBacklightContrast"] = new RoveCommPacketDesc(14009, 2, RoveCommDataType.UINT8_T),
                // Set exposure level. [0] is the camera ID, [1] is the exposure level.
                ["SetExposure"] = new RoveCommPacketDesc(14010, 2, RoveCommDataType.INT32_T)
            },
            telemetry: new Dictionary<string, RoveCommPacketDesc>
            {
                // Bitmask values for which cameras are able to stream. LSB is Camera 0, MSB is Camera 7.
                ["AvailableCameras"] = new RoveCommPacketDesc(14100, 1, RoveCommDataType.UINT8_T),
                // Which cameras the system is currently streaming on each port
                ["StreamingCameras"] = new RoveCommPacketDesc(14101, 4, RoveCommDataType.UINT8_T),
                // Picture has been taken.
